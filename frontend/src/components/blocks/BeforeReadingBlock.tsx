    ...
    <div className="block-card" style={{ boxShadow: 'inset 3px 0 0 oklch(0.74 0.008 270)' }} data-screen-label="Block: Before reading">
      ...
      <div className="block-body">
        ...
        <p className="font-serif text-[15.5px] leading-relaxed text-ink-2">
          Shrodinger has read the chapter and pre-marked four <em>fragile</em> concepts: places where students typically conflate roles or invert a constraint. You'll meet a checkpoint at each one.
        </p>
